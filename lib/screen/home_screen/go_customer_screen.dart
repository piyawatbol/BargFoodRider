...
class GoCustomerScreen extends StatefulWidget {
  GoCustomerScreen({Key? key}) : super(key: key);

  @override
  State<GoCustomerScreen> createState() => _GoCustomerScreenState();
}

class _GoCustomerScreenState extends State<GoCustomerScreen> {
