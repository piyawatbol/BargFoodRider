    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: AutoText(
          ...
          text: 'Add Wallet', width: null, text_align: null,
        ),
      ),
      body: Stack(
        children: [
                  ...
                  child: Column(
                    ...
                    children: [
                      AutoText(
                        ...
                        fontSize: 24,
                        fontWeight: null,
                        text: 'Top up amount', width: null, text_align: null,
                      ),
                      Row(
                        children: [
                          AutoText(
                            ...
                            fontSize: 14,
                            fontWeight: null,
                            text: 'amount', text_align: null, width: null,
                          ),
                          SizedBox(width: 5),
                          AutoText(
                            color: Colors.grey,
                            fontSize: 12,
                            fontWeight: null,
                            text: '( balance ${widget.wallet_total} ฿ )', text_align: null, width: null,
                          ),
                        ],
                      ),
                    ],
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      AutoText(
                        ...
                        fontSize: 16,
                        fontWeight: null,
                        text: 'Banking', text_align: null, width: null,
                      ),
                      TextField(
                        cursorColor: Colors.black,
                        controller: bank,
          ...
          child: ElevatedButton(
            ...
            child: Center(
              child: AutoText(
                ...
                fontSize: 14,
                text: 'Continue',
                fontWeight: FontWeight.bold, text_align: null, width: null,
              ),
            ),
          ),
        ),
